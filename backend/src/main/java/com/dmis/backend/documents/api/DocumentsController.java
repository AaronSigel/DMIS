...
public class DocumentsController {
    ...
    public DocumentDtos.PresignedDownloadUrl getDownloadUrl(@PathVariable("documentId") String documentId) {
        return documentUseCases.getDownloadUrl(currentUserProvider.currentUser(), documentId);
    }
